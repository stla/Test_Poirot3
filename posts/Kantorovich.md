...
<!-- ****** points object 131 ****** -->
<script id="unnamed_chunk_1vshader131" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
...
<script id="unnamed_chunk_1fshader131" type="x-shader/x-fragment"> 
	#ifdef GL_ES
...
<!-- ****** quads object 132 ****** -->
<script id="unnamed_chunk_1vshader132" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_1fshader132" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 133 ****** -->
<script id="unnamed_chunk_1vshader133" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_1fshader133" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<script type="text/javascript"> 
	...
	function unnamed_chunk_1webGLStart() {
	   ...
	   gl.attachShader(prog131, getShader( gl, "unnamed_chunk_1vshader131" ));
	   gl.attachShader(prog131, getShader( gl, "unnamed_chunk_1fshader131" ));
	   ...
	   gl.attachShader(prog132, getShader( gl, "unnamed_chunk_1vshader132" ));
	   gl.attachShader(prog132, getShader( gl, "unnamed_chunk_1fshader132" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var normLoc132 = gl.getAttribLocation(prog132, "aNorm");
	   ...
	   var normMatLoc132 = gl.getUniformLocation(prog132,"normMatrix");
	   // ****** text object 133 ******
	   var prog133  = gl.createProgram();
	   gl.attachShader(prog133, getShader( gl, "unnamed_chunk_1vshader133" ));
	   gl.attachShader(prog133, getShader( gl, "unnamed_chunk_1fshader133" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var canvasX133 = texinfo.canvasX;
	   var canvasY133 = texinfo.canvasY;
	   var ofsLoc133 = gl.getAttribLocation(prog133, "aOfs");
	   var texture133 = gl.createTexture();
	   var texLoc133 = gl.getAttribLocation(prog133, "aTexcoord");
	   var sampler133 = gl.getUniformLocation(prog133,"uSampler");
    	   handleLoadedTexture(texture133, document.getElementById("unnamed_chunk_1textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.bufferData(gl.ARRAY_BUFFER, v, gl.STATIC_DRAW);
	   var ibuf133 = gl.createBuffer();
	   gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, ibuf133);
	   gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f, gl.STATIC_DRAW);
	   ...
	   function drawScene(){
	     ...
	     gl.uniformMatrix4fv( normMatLoc132, false, new Float32Array(normMatrix.getAsArray()) );
	     gl.enableVertexAttribArray( posLoc );
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0, 1, 0, 1 );
	     gl.enableVertexAttribArray( normLoc132 );
	     gl.vertexAttribPointer(normLoc132, 3, gl.FLOAT, false, 24, 12);
	     ...
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0, 1, 0, 1 );
	     gl.enableVertexAttribArray( texLoc133 );
	     gl.vertexAttribPointer(texLoc133, 2, gl.FLOAT, false, 28, 12);
	     gl.activeTexture(gl.TEXTURE0);
	     gl.bindTexture(gl.TEXTURE_2D, texture133);
	     gl.uniform1i( sampler133, 0);
	     gl.enableVertexAttribArray( ofsLoc133 );
	     gl.vertexAttribPointer(ofsLoc133, 2, gl.FLOAT, false, 28, 20);
...
<img src="unnamed_chunk_2snapshot.png" alt="unnamed_chunk_2snapshot" width=505/><br>
	Your browser does not support the HTML5 canvas element.</canvas>
<!-- ****** lines object 135 ****** -->
<script id="unnamed_chunk_2vshader135" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader135" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 136 ****** -->
<script id="unnamed_chunk_2vshader136" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader136" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 137 ****** -->
<script id="unnamed_chunk_2vshader137" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader137" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 138 ****** -->
<script id="unnamed_chunk_2vshader138" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader138" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 139 ****** -->
<script id="unnamed_chunk_2vshader139" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader139" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** surface object 140 ****** -->
<script id="unnamed_chunk_2vshader140" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader140" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 141 ****** -->
<script id="unnamed_chunk_2vshader141" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader141" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** points object 142 ****** -->
<script id="unnamed_chunk_2vshader142" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader142" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** quads object 143 ****** -->
<script id="unnamed_chunk_2vshader143" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader143" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** points object 144 ****** -->
<script id="unnamed_chunk_2vshader144" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader144" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 145 ****** -->
<script id="unnamed_chunk_2vshader145" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader145" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 146 ****** -->
<script id="unnamed_chunk_2vshader146" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader146" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** points object 147 ****** -->
<script id="unnamed_chunk_2vshader147" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader147" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** points object 148 ****** -->
<script id="unnamed_chunk_2vshader148" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader148" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** linestrip object 149 ****** -->
<script id="unnamed_chunk_2vshader149" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader149" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 150 ****** -->
<script id="unnamed_chunk_2vshader150" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader150" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 151 ****** -->
<script id="unnamed_chunk_2vshader151" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="unnamed_chunk_2fshader151" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<script type="text/javascript"> 
	...
	function unnamed_chunk_2webGLStart() {
	   ...
	   gl.attachShader(prog135, getShader( gl, "unnamed_chunk_2vshader135" ));
	   gl.attachShader(prog135, getShader( gl, "unnamed_chunk_2fshader135" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog136, getShader( gl, "unnamed_chunk_2vshader136" ));
	   gl.attachShader(prog136, getShader( gl, "unnamed_chunk_2fshader136" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog137, getShader( gl, "unnamed_chunk_2vshader137" ));
	   gl.attachShader(prog137, getShader( gl, "unnamed_chunk_2fshader137" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var texinfo = drawTextToCanvas(texts, 1);	 
	   var canvasX137 = texinfo.canvasX;
	   var canvasY137 = texinfo.canvasY;
	   var ofsLoc137 = gl.getAttribLocation(prog137, "aOfs");
	   var texture137 = gl.createTexture();
	   var texLoc137 = gl.getAttribLocation(prog137, "aTexcoord");
	   var sampler137 = gl.getUniformLocation(prog137,"uSampler");
    	   handleLoadedTexture(texture137, document.getElementById("unnamed_chunk_2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.bufferData(gl.ARRAY_BUFFER, v, gl.STATIC_DRAW);
	   var ibuf137 = gl.createBuffer();
	   gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, ibuf137);
	   gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f, gl.STATIC_DRAW);
	   ...
	   gl.attachShader(prog138, getShader( gl, "unnamed_chunk_2vshader138" ));
	   gl.attachShader(prog138, getShader( gl, "unnamed_chunk_2fshader138" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var sampler138 = gl.getUniformLocation(prog138,"uSampler");
    	   handleLoadedTexture(texture138, document.getElementById("unnamed_chunk_2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.attachShader(prog139, getShader( gl, "unnamed_chunk_2vshader139" ));
	   gl.attachShader(prog139, getShader( gl, "unnamed_chunk_2fshader139" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var texinfo = drawTextToCanvas(texts, 1);	 
	   var canvasX139 = texinfo.canvasX;
	   var canvasY139 = texinfo.canvasY;
	   var ofsLoc139 = gl.getAttribLocation(prog139, "aOfs");
	   var texture139 = gl.createTexture();
	   var texLoc139 = gl.getAttribLocation(prog139, "aTexcoord");
	   var sampler139 = gl.getUniformLocation(prog139,"uSampler");
    	   handleLoadedTexture(texture139, document.getElementById("unnamed_chunk_2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.bufferData(gl.ARRAY_BUFFER, v, gl.STATIC_DRAW);
	   var ibuf139 = gl.createBuffer();
	   gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, ibuf139);
	   gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f, gl.STATIC_DRAW);
	   ...
	   gl.attachShader(prog140, getShader( gl, "unnamed_chunk_2vshader140" ));
	   gl.attachShader(prog140, getShader( gl, "unnamed_chunk_2fshader140" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var normLoc140 = gl.getAttribLocation(prog140, "aNorm");
	   var centers140 = new Float32Array([
	   ...
	   gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f140, gl.DYNAMIC_DRAW);
	   var mvMatLoc140 = gl.getUniformLocation(prog140,"mvMatrix");
	   var prMatLoc140 = gl.getUniformLocation(prog140,"prMatrix");
	   var normMatLoc140 = gl.getUniformLocation(prog140,"normMatrix");
	   // ****** lines object 141 ******
	   var prog141  = gl.createProgram();
	   gl.attachShader(prog141, getShader( gl, "unnamed_chunk_2vshader141" ));
	   gl.attachShader(prog141, getShader( gl, "unnamed_chunk_2fshader141" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog142, getShader( gl, "unnamed_chunk_2vshader142" ));
	   gl.attachShader(prog142, getShader( gl, "unnamed_chunk_2fshader142" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog143, getShader( gl, "unnamed_chunk_2vshader143" ));
	   gl.attachShader(prog143, getShader( gl, "unnamed_chunk_2fshader143" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var normLoc143 = gl.getAttribLocation(prog143, "aNorm");
	   var f=new Uint16Array([
	    0, 1, 2, 0, 2, 3
	   ]);
	   ...
	   var normMatLoc143 = gl.getUniformLocation(prog143,"normMatrix");
	   // ****** points object 144 ******
	   var prog144  = gl.createProgram();
	   gl.attachShader(prog144, getShader( gl, "unnamed_chunk_2vshader144" ));
	   gl.attachShader(prog144, getShader( gl, "unnamed_chunk_2fshader144" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog145, getShader( gl, "unnamed_chunk_2vshader145" ));
	   gl.attachShader(prog145, getShader( gl, "unnamed_chunk_2fshader145" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog146, getShader( gl, "unnamed_chunk_2vshader146" ));
	   gl.attachShader(prog146, getShader( gl, "unnamed_chunk_2fshader146" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog147, getShader( gl, "unnamed_chunk_2vshader147" ));
	   gl.attachShader(prog147, getShader( gl, "unnamed_chunk_2fshader147" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog148, getShader( gl, "unnamed_chunk_2vshader148" ));
	   gl.attachShader(prog148, getShader( gl, "unnamed_chunk_2fshader148" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog149, getShader( gl, "unnamed_chunk_2vshader149" ));
	   gl.attachShader(prog149, getShader( gl, "unnamed_chunk_2fshader149" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog150, getShader( gl, "unnamed_chunk_2vshader150" ));
	   gl.attachShader(prog150, getShader( gl, "unnamed_chunk_2fshader150" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var sampler150 = gl.getUniformLocation(prog150,"uSampler");
    	   handleLoadedTexture(texture150, document.getElementById("unnamed_chunk_2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.attachShader(prog151, getShader( gl, "unnamed_chunk_2vshader151" ));
	   gl.attachShader(prog151, getShader( gl, "unnamed_chunk_2fshader151" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var sampler151 = gl.getUniformLocation(prog151,"uSampler");
    	   handleLoadedTexture(texture151, document.getElementById("unnamed_chunk_2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   function drawScene(){
	     ...
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0, 0, 0, 1 );
	     gl.enableVertexAttribArray( texLoc137 );
	     gl.vertexAttribPointer(texLoc137, 2, gl.FLOAT, false, 28, 12);
	     gl.activeTexture(gl.TEXTURE0);
	     gl.bindTexture(gl.TEXTURE_2D, texture137);
	     gl.uniform1i( sampler137, 0);
	     gl.enableVertexAttribArray( ofsLoc137 );
	     gl.vertexAttribPointer(ofsLoc137, 2, gl.FLOAT, false, 28, 20);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 28,  0);
	     gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 0);
	     // ****** text object 138 *******
	     ...
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0, 0, 0, 1 );
	     gl.enableVertexAttribArray( texLoc139 );
	     gl.vertexAttribPointer(texLoc139, 2, gl.FLOAT, false, 28, 12);
	     gl.activeTexture(gl.TEXTURE0);
	     gl.bindTexture(gl.TEXTURE_2D, texture139);
	     gl.uniform1i( sampler139, 0);
	     gl.enableVertexAttribArray( ofsLoc139 );
	     gl.vertexAttribPointer(ofsLoc139, 2, gl.FLOAT, false, 28, 20);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 28,  0);
	     gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 0);
	     // ****** lines object 141 *******
	     ...
	     gl.uniformMatrix4fv( normMatLoc143, false, new Float32Array(normMatrix.getAsArray()) );
	     gl.enableVertexAttribArray( posLoc );
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0, 1, 0, 1 );
	     gl.enableVertexAttribArray( normLoc143 );
	     gl.vertexAttribPointer(normLoc143, 3, gl.FLOAT, false, 24, 12);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 24,  0);
	     gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 0);
	     // ****** points object 144 *******
	     ...
	     gl.vertexAttribPointer(texLoc150, 2, gl.FLOAT, false, 44, 28);
	     gl.activeTexture(gl.TEXTURE0);
	     gl.bindTexture(gl.TEXTURE_2D, texture150);
	     gl.uniform1i( sampler150, 0);
	     gl.enableVertexAttribArray( ofsLoc150 );
	     gl.vertexAttribPointer(ofsLoc150, 2, gl.FLOAT, false, 44, 36);
	     ...
	     gl.vertexAttribPointer(texLoc151, 2, gl.FLOAT, false, 44, 28);
	     gl.activeTexture(gl.TEXTURE0);
	     gl.bindTexture(gl.TEXTURE_2D, texture151);
	     gl.uniform1i( sampler151, 0);
	     gl.enableVertexAttribArray( ofsLoc151 );
	     gl.vertexAttribPointer(ofsLoc151, 2, gl.FLOAT, false, 44, 36);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 44,  0);
	     gl.drawElements(gl.TRIANGLES, 30, gl.UNSIGNED_SHORT, 0);
	     ...
	     gl.uniformMatrix4fv( normMatLoc140, false, new Float32Array(normMatrix.getAsArray()) );
	     gl.enableVertexAttribArray( posLoc );
	     var depths = new Float32Array(841);
	     var faces = new Array(841);
	     for(var i=0; i<841; i++) {
	       var z = prmvMatrix.m13*centers140[3*i] 
	             + prmvMatrix.m23*centers140[3*i+1]
	             + prmvMatrix.m33*centers140[3*i+2]
	             + prmvMatrix.m43;
	       var w = prmvMatrix.m14*centers140[3*i] 
	             + prmvMatrix.m24*centers140[3*i+1]
	             + prmvMatrix.m34*centers140[3*i+2]
	             + prmvMatrix.m44;
	       depths[i] = z/w;
	       faces[i] = i;
	     }
	     ...
	     var f = new Uint16Array(f140.length);
	     for (var i=0; i<841; i++) {
	       for (var j=0; j<6; j++) {
	         f[6*i + j] = f140[6*faces[i] + j];
	       }
	     }	     
	     gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f, gl.DYNAMIC_DRAW);
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0.6784314, 0.8470588, 0.9019608, 0.4980392 );
	     gl.enableVertexAttribArray( normLoc140 );
	     gl.vertexAttribPointer(normLoc140, 3, gl.FLOAT, false, 24, 12);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 24,  0);
