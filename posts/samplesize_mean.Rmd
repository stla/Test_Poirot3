...
```{r setup, echo=FALSE}
opts_chunk$set(fig.path="assets/fig/samplesizemean-")
set.seed(666)
mu <- 10
sigma <- 1
```
...
The upper confidence bound is approximately `r round(dfplot$hw.upper[dfplot$n==9],2)` for $n=9$ and approximately `r round(dfplot$hw.upper[dfplot$n==10],2)` for $n=10$.  
